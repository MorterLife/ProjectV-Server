...
public class DonationManager {
	...
	public static void execute(Player player) throws SQLException {
		player.getActionSender().sendMessage("Thank you for supporting ProjectV! If you have any donator feature suggestions please post them!");
		...
		connectionProps.put("user", "justausername");
		connectionProps.put("password", "justapassword");
