				...
				if (slot >= 0 && slot < Inventory.SIZE) {
					...
					case 20703:
						...
						case 11941:
							...
							break;
						case 12728:
							if (player.getInventory().add(new Item(556, 500))) {
								player.getInventory().remove(new Item(12728, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Air runes.");
							}
							break;
						case 12730:
							if (player.getInventory().add(new Item(555, 500))) {
								player.getInventory().remove(new Item(12730, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Water runes.");
							}
							break;
						case 12732:
							if (player.getInventory().add(new Item(557, 500))) {
								player.getInventory().remove(new Item(12732, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Earth runes.");
							}
							break;
						case 12734:
							if (player.getInventory().add(new Item(554, 500))) {
								player.getInventory().remove(new Item(12734, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Fire runes.");
							}
							break;
						case 12859:
							if (player.getInventory().add(new Item(222, 500))) {
								player.getInventory().remove(new Item(12859, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Newt Eyes.");
							}
							break;
						case 12736:
							if (player.getInventory().add(new Item(558, 500))) {
								player.getInventory().remove(new Item(12736, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Mind runes.");
							}
							break;
						case 12738:
							if (player.getInventory().add(new Item(562, 500))) {
								player.getInventory().remove(new Item(12738, 1), slot);
								player.getActionSender().sendMessage("You turn your pack into 500x Chaos runes.");
							}
							break;
						case 526:
						case 528:
