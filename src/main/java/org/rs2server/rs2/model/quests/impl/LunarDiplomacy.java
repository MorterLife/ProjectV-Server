...
public class LunarDiplomacy extends Quest<LunarStates> {
    ...
    public boolean hasRequirements() {
        return player.getSkills().getLevelForExperience(Skills.FLETCHING) > 59 && player.getSkills().getLevelForExperience(Skills.RANGE) > 59 && player.getSkills().getLevelForExperience(Skills.DEFENCE) > 39 && player.getSkills().getLevelForExperience(Skills.ATTACK) > 59 && player.getSkills().getLevelForExperience(Skills.STRENGTH) > 59 && player.getSkills().getLevelForExperience(Skills.MAGIC) > 65;
    }
