...
public class RangeCombatAction extends AbstractCombatAction {
    ...
    public void addExperience(Mob attacker, int damage) {
        ...
        if (attacker.getCombatState().getCombatStyle() == CombatStyle.DEFENSIVE) {
            //Longrange
            attacker.getSkills().addExperience(Skills.RANGE, (damage) * Constants.COMBAT_EXP * 1);
            attacker.getSkills().addExperience(Skills.DEFENCE, (damage) * Constants.COMBAT_EXP * 1);
        } else {
            attacker.getSkills().addExperience(Skills.RANGE, (damage) * Constants.COMBAT_EXP * 1);
        }
    }
    ...
    public static enum BowType {
        ...
        HEAVY_BALLISTA(new ArrowType[]{ ArrowType.DRAGON_JAVELIN },
                new int[]{7, 7, 9}),
