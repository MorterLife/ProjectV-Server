...
public class GroundItemController {
    ...
    /*
     * Constants, the stages of the ground item. Total span: 4 minutes. // Wrong. It is 2 minutes
     * Source: http://2007.runescape.wikia.com/wiki/Drop
     * Cannot find if this counts for NPC drops too. But until then, 2 minutes it is.
     */
    public static final int APPEAR_FOR_EVERYONE = 60;
    public static final int DISAPPEAR = 60;
}