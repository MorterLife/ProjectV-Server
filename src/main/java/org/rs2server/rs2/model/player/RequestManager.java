...
//		if (permissionService.isAny(player, PermissionService.PlayerPermissions.IRON_MAN, PermissionService.PlayerPermissions.ULTIMATE_IRON_MAN, PermissionService.PlayerPermissions.HARDCORE_IRON_MAN) && !permissionService.is(acquaintance, PermissionService.PlayerPermissions.DEV)) {
//			player.getActionSender().sendMessage("You are an iron man and cannot trade.");
//			cancelRequest();
//			return;
//		}
//
//		if (permissionService.isAny(acquaintance, PermissionService.PlayerPermissions.IRON_MAN, PermissionService.PlayerPermissions.ULTIMATE_IRON_MAN, PermissionService.PlayerPermissions.HARDCORE_IRON_MAN) && !permissionService.is(player, PermissionService.PlayerPermissions.DEV)) {
