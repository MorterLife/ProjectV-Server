                ...
                if (loot != null) {
                    ...
                    if (pets != null) {
                        if (player.getPet() != null) {
                            ...
                            World.getWorld().sendWorldMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received " + item.getCount() + "x " + item.getDefinition2().getName() + ".");
                            continue;
                        }
                    }
...
//                        item.setId(537);
//                    }
                    if (item.getDefinition() != null && loot.getHitRollCeil() < 3.0 || isBossNPC(this.getId()) || (item.getDefinition2().getName() != null && item.getDefinition2().getName().toLowerCase().contains("clue"))) {
						...
						if (loot.getHitRollCeil() <= 5) {//3
							World.getWorld().sendWorldMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received " + item.getCount() + "x " + lastName + ".");
						} else {
							player.getRegion().getPlayers().stream().filter(p -> p != player).forEach(p -> {
								p.getActionSender().sendMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received " + item.getCount() + "x " + lastName + ".");
							});
							player.getActionSender().sendMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received " + item.getCount() + "x " + lastName + ".");
						}
                    }
