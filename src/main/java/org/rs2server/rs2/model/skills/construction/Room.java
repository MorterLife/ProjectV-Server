...
public class Room {
	...
	public void build(Location location, int objectId) {
		if(!player.getConstruction().isInBuildingMode()) {
			...
			for(int index = 0; index < hotspots.length; index++) {
				...
				Location local = Location.create(hotspot.getLocation().getX() + x, hotspot.getLocation().getY() + y, hotspot.getLocation().getZ());
	...
	public GameObject[] getHotspots(Player player, boolean clockwise) {
		...
		for(int index = 0; index < hotspots.length; index++) {
			...
			Location local = Location.create(object.getLocation().getX() + this.getX(), object.getLocation().getY() + this.getY(), object.getLocation().getZ());
