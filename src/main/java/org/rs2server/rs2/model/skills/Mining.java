...
public class Mining extends HarvestingAction {
	...
	public static enum Rock {
		 ...
		 * Clay ore.
		 */
		CLAY(434, 1, 10, 2, 1, new int[] { 13456, 13457, 14176, 14181, 7454, 7487 }, new int[] { 13459, 13460, 10798, 10796,7468,7468}, 10000),
		 ...
		 * Silver ore.
		 */
		SILVER(442, 20, 80, 100, 1, new int[] { 8976, 8977, 8978,  13439, 13440, 13447, 13438, 7457, 7490 }, new int[] { 8979, 8980, 8981, 13460, 13461, 13459, 13459,7468,7468}, 8500),
...
//		this.petRate = petRate;
		 ...
		 * Adamantite ore.
		 */
		ADAMANTITE(449, 70, 190, 400, 1, new int[] { 7460, 7493 }, new int[] { 7469 }, 2000),
	...
	public double getExperience() {
		...
		if (random == 0) {
			...
			if (player.getPet() != null) {
				...
				World.getWorld().sendWorldMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received 1x Rock Golem.");
				return rock.getExperience() * (getMob().isPlayer() ? miningService.getProspectorKitExperienceModifier((Player) getMob()) : 1f) * 2;
			}
		}
		return rock.getExperience() * (getMob().isPlayer() ? miningService.getProspectorKitExperienceModifier((Player) getMob()) : 1f) * 2;
