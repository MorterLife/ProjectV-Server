...
public class Cooking extends ProductionAction {
	...
	public enum CookingMethod {
		...
		STOVE(Animation.create(883), new int[]{114, 2728, 2729, 2730, 2731, 4488, 14919, 26181, 27724}), FIRE(
				Animation.create(897), new int[]{5249, 26185}), FIRE_PLACE(
...
//				new Item(15266), true),
		...
		RAW_DARK_CRAB(90, new Item[]{new Item(11934)}, new Item(11938), 250,
				new Item(11936), true), RAW_RAT_MEAT(1, new Item[]{new Item(
				2134)}, new Item(2146), 35, new Item(2124), true), RAW_BEAR_MEAT(
				1, new Item[]{new Item(2134)}, new Item(2146), 35, new Item(
				2124), true), RAW_BEEF(1,
				new Item[]{new Item(2132)}, new Item(2146), 35, new Item(
				2124), true), RAW_CHICKEN(1,
				new Item[]{new Item(1)}, new Item(1), 35, new Item(1), true), STEW(
				25, new Item[]{new Item(1997)}, new Item(2005), 230,
				new Item(2003), true),
