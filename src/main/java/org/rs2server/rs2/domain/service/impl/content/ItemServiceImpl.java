...
public class ItemServiceImpl implements ItemService {
	...
	enum Upgradable {
		...
		INFERNAL_AXE(new Item(13233), new Item(13241), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the smouldering stone with your axe to create "+i.getDefinition2().getName()+"."), 6739),

		INFERNAL_PICKAXE(new Item(13233), new Item(13243), UpgradeStrategy.ON_ITEM_USE, (s, p, i, c) -> p.getActionSender().sendMessage("You combine the smouldering stone with your axe to create "+i.getDefinition2().getName()+"."), 11920),
	...
	public void gambleFireCapes(@Nonnull Player player, int amount) {
		...
		for (int i = 0; i < amount; i++) {
			...
			if (Misc.random(100) == 1 && player.getPet() == null) {
				...
				World.getWorld().sendWorldMessage("<col=880000><img=33>Drops: <col=880000>" + player.getName() + " has just received 1x TzRek-Jad.");
				break;
			}
		}
	}
