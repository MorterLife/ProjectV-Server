...
public class TeleportManager {
	...
	public static boolean handleTeleportAction(Player player, int option) {
		...
		switch (option) {
		case 8:
			player.getActionSender().sendMessage("Teleports that take you to various Monster locations.");
